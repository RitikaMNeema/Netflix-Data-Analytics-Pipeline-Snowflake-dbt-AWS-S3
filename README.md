...
Plan marketing campaigns: Decide which genres or directors to invest in next.
...
Real-World Impact: This project mirrors how data teams in real businesses operate:
